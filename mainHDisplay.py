...
titre_label.grid(row=2, column=0)
titre_entry.grid(row=2, column=1)

nomAuteur_label.grid(row=2, column=2)
nomAuteur_entry.grid(row=2, column=3)

annee_label.grid(row=3, column=0)
annee_entry.grid(row=3, column=1)

prenomAuteur_label.grid(row=3, column=2)
prenomAuteur_entry.grid(row=3, column=3)

nbreChansons_label.grid(row=5, column=2)
nbreChansons_entry.grid(row=5, column=3)


ajouter_button.grid(row=6, column=1, columnspan=3, pady=10)
switch_to_display_button.grid(row=6, column=3, columnspan=2)
